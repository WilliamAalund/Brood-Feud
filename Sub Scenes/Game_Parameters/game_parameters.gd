...
const PLAYER_DEFAULT_IDLE_SATIATION_DRAIN_RATE = 0.03 # Rate that the player loses satiation at the beginning of the game
...
const IDLE_SATIATION_DRAIN_RATE = 0.05 # Idle decrease in satiation that a bird takes simply for existing.
